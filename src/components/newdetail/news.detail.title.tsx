...
const NewsDeatailTitleComponent = () => {
  ...
  // useEffect to set the initial state of the Accordion body to closed
  useEffect(() => {
          ...
          <Col lg={9} md={12}>
            <p>
              <strong className="news-detai-title mb-2">
                Tìm kiếm phòng khám phụ sản gần nhất tại TPHCM đang khiến nhiều
                chị em đau đầu. Khám sản phụ khoa là nhu cầu cần thiết của nữ
                giới vì liên quan trực tiếp tới sức khỏe và thiên chức làm mẹ.
                Hãy tham khảo địa chỉ phòng khám phụ sản tốt ngay tại TPHCM mà
                chúng tôi giới thiệu ngay sau đây.
              </strong>
            </p>
              ...
              <Accordion.Item eventKey="0" className="border-1 rounded">
                ...
                <Accordion.Body className="py-0">
                  <ListGroup as="ol" numbered>
                    ...
                    <ListGroup.Item as="li" className="border-0">
                      <a href="" className="text-decoration-none text-dark">
                        Vì sao phòng khám sản phụ khoa bác sĩ Điệp được đánh giá
                        tốt nhất?
                      </a>
                      <ListGroup.Item as="li" className="border-0">
                        <a href="" className="text-decoration-none text-dark">
                          2.1 Quy tụ đội ngũ bác sĩ giỏi chuyên môn, tận tâm với
                          nghề
                        </a>
                      </ListGroup.Item>
                      <ListGroup.Item as="li" className="border-0">
                        <a href="" className="text-decoration-none text-dark">
                          2.2 Phòng khám phụ khoa Bác Sĩ Điệp đã được cấp phép
                          hoạt động minh bạch
                        </a>
                      </ListGroup.Item>
                      <ListGroup.Item as="li" className="border-0">
                        <a href="" className="text-decoration-none text-dark">
                          2.3 Phòng khám phụ khoa tốt có trang bị cơ sở vật chất
                          hiện đại bậc nhất
                        </a>
                      </ListGroup.Item>
                      <ListGroup.Item as="li" className="border-0">
